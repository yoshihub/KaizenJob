...
const handleSubmit = () => {
    router.put(`/posts/${props.post.id}`, form.value);
};
...
<App>
    ...
    <div class="row bg-light text-dark py-1">
        <div class="col-md-8 offset-md-2">
            <h2 class="fs-1 mb-5 text-center fw-bold">改善編集</h2>
            <form method="post" @submit.prevent="handleSubmit">
                ...
                <div class="mb-4">
                    <textarea class="form-control textarea-enter" name="content" rows="5" placeholder="内容を入力してください" v-model="form.content"></textarea>
